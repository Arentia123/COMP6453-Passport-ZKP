...
type INPUT_SIGNALS = [
	...
	"expected_root", "depth", "indices", "siblings"
];
...
const mockPassportData: CircuitSignals<INPUT_SIGNALS> = {
...
addPoM(mockPassportData);

export { INPUT_SIGNALS, MAX_DEPTH, mockPassportData };
